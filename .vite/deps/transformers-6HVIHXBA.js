...
var require_web = __commonJS({
  "browser-external:stream/web"(exports, module) {
...
// node_modules/chromadb-default-embed/src/utils/core.js
...
// node_modules/chromadb-default-embed/src/utils/hub.js
var import_fs2 = __toESM(require_fs(), 1);
var import_path2 = __toESM(require_path(), 1);
var import_web = __toESM(require_web(), 1);

// node_modules/chromadb-default-embed/src/env.js
var import_fs = __toESM(require_fs(), 1);
var import_path = __toESM(require_path(), 1);
var import_url = __toESM(require_url(), 1);

// node_modules/chromadb-default-embed/src/backends/onnx.js
...
var FS_AVAILABLE = !isBrowser() && !isEmpty(import_fs.default);
var PATH_AVAILABLE = !isBrowser() && !isEmpty(import_path.default);
...
async function getModelFile(path_or_repo_id, filename, fatal = true, options = {}) {
  ...
  let remoteURL = pathJoin(
    env.remoteHost,
    env.remotePathTemplate.replaceAll("{model}", path_or_repo_id).replaceAll("{revision}", revision),
    filename
  );
...
// node_modules/chromadb-default-embed/src/utils/maths.js
...
// node_modules/chromadb-default-embed/src/utils/tensor.js
...
// node_modules/chromadb-default-embed/src/utils/data-structures.js
...
// node_modules/chromadb-default-embed/node_modules/@huggingface/jinja/dist/index.js
...
var Environment = class {
  ...
  setVariable(name, value) {
    let env3;
    try {
      env3 = this.resolve(name);
    } catch {
    }
    (env3 ?? this).variables.set(name, value);
    return value;
  }
  /**
...
// node_modules/chromadb-default-embed/src/tokenizers.js
...
function createPattern(pattern, invert = true) {
  if (pattern.Regex !== void 0) {
    const regex = pattern.Regex.replace(/\\([#&~])/g, "$1");
...
' }}{% endif %}`);
  ...
  encode(text, text_pair = null, {
    ...
    let combinedTokens = this.post_processor !== null && add_special_tokens ? this.post_processor(tokens, tokens2) : mergeArrays(tokens ?? [], tokens2 ?? []);
...
function _build_translation_inputs(self2, raw_inputs, tokenizer_options, generate_kwargs) {
  ...
  if (src_lang_token !== void 0) {
    ...
    for (let item of self2.post_processor.config.single) {
...
var AutoTokenizer = class {
  ...
  static async from_pretrained(pretrained_model_name_or_path, {
    ...
    let tokenizerName = ((_a2 = tokenizerConfig.tokenizer_class) == null ? void 0 : _a2.replace(/Fast$/, "")) ?? "PreTrainedTokenizer";
...
// node_modules/chromadb-default-embed/src/configs.js
...
// node_modules/chromadb-default-embed/src/utils/generation.js
...
// node_modules/chromadb-default-embed/src/models.js
...
var MODEL_MAPPING_NAMES_ENCODER_ONLY = /* @__PURE__ */ new Map([
  ...
  // TODO change to encoder-decoder when model is split correctly
]);
...
__publicField(AutoModel, "MODEL_CLASS_MAPPINGS", [MODEL_MAPPING_NAMES_ENCODER_ONLY, MODEL_MAPPING_NAMES_ENCODER_DECODER, MODEL_MAPPING_NAMES_DECODER_ONLY]);
...
// node_modules/chromadb-default-embed/src/utils/image.js
...
// node_modules/chromadb-default-embed/src/utils/audio.js
...
function spectrogram(waveform, window2, frame_length, hop_length, {
  ...
  const dims = transpose2 ? [d1Max, num_mel_filters] : [num_mel_filters, d1Max];
  for (let i = 0; i < num_mel_filters; ++i) {
    const filter = mel_filters[i];
    for (let j = 0; j < d1; ++j) {
      ...
      mel_spec[transpose2 ? j * num_mel_filters + i : i * d1 + j] = Math.max(mel_floor, sum);
    }
  }
...
// node_modules/chromadb-default-embed/src/processors.js
...
var ImageFeatureExtractor = class extends FeatureExtractor {
  ...
  async preprocess(image, {
    ...
    if (this.do_resize) {
      ...
      } else if (this.size !== void 0 && this.size.width !== void 0 && this.size.height !== void 0) {
    ...
    const transposed = transpose(img, [2, 0, 1]);
    return {
...
// node_modules/chromadb-default-embed/src/pipelines.js
...
var TextClassificationPipeline = class extends /** @type {new (options: TextPipelineConstructorArgs) => TextClassificationPipelineCallback} */
/** @type {any} */
Pipeline {
  /**
  ...
  async _call(texts, {
    ...
    const model_inputs = self2.tokenizer(texts, {
      padding: true,
      truncation: true
    });
    const outputs = await self2.model(model_inputs);
    const function_to_apply = self2.model.config.problem_type === "multi_label_classification" ? (batch) => batch.sigmoid().data : (batch) => softmax(batch.data);
    const id2label = self2.model.config.id2label;
    const toReturn = [];
...
var TokenClassificationPipeline = class extends /** @type {new (options: TextPipelineConstructorArgs) => TokenClassificationPipelineCallback} */
/** @type {any} */
Pipeline {
  /**
  ...
  async _call(texts, {
    ...
    const self2 = (
      /** @type {TokenClassificationPipeline & Pipeline} */
      /** @type {any} */
      this
    );
    const isBatched = Array.isArray(texts);
    const model_inputs = self2.tokenizer(isBatched ? texts : [texts], {
      padding: true,
      truncation: true
    });
    const outputs = await self2.model(model_inputs);
    ...
    for (let i = 0; i < logits.dims[0]; ++i) {
      ...
      for (let j = 0; j < batch.dims[0]; ++j) {
        ...
        const word = self2.tokenizer.decode([ids[j].item()], { skip_special_tokens: true });
        if (word === "") {
          continue;
        }
...
var QuestionAnsweringPipeline = class extends /** @type {new (options: TextPipelineConstructorArgs) => QuestionAnsweringPipelineCallback} */
/** @type {any} */
Pipeline {
  /**
  ...
  async _call(question, context, {
    ...
    const self2 = (
      /** @type {QuestionAnsweringPipeline & Pipeline} */
      /** @type {any} */
      this
    );
    const inputs = self2.tokenizer(question, {
      text_pair: context,
      padding: true,
      truncation: true
    });
    const output = await self2.model(inputs);
    const toReturn = [];
    for (let j = 0; j < output.start_logits.dims[0]; ++j) {
      const ids = inputs.input_ids[j];
      const sepIndex = ids.indexOf(self2.tokenizer.sep_token_id);
      ...
      for (let k = 0; k < Math.min(options.length, topk); ++k) {
        ...
        const answer = self2.tokenizer.decode(answer_tokens, {
...
var FillMaskPipeline = class extends /** @type {new (options: TextPipelineConstructorArgs) => FillMaskPipelineCallback} */
/** @type {any} */
Pipeline {
  /**
  ...
  async _call(texts, {
    ...
    const self2 = (
      /** @type {FillMaskPipeline & Pipeline} */
      /** @type {any} */
      this
    );
    const model_inputs = self2.tokenizer(texts, {
    ...
    for (let i = 0; i < model_inputs.input_ids.dims[0]; ++i) {
      const ids = model_inputs.input_ids[i];
      const mask_token_index = ids.indexOf(self2.tokenizer.mask_token_id);
      if (mask_token_index === -1) {
        throw Error(`Mask token (${self2.tokenizer.mask_token}) not found in text.`);
      }
      ...
      toReturn.push(scores.map((x) => {
        ...
        return {
          score: x[1],
          token: x[0],
          token_str: self2.tokenizer.model.vocab[x[0]],
          sequence: self2.tokenizer.decode(sequence, { skip_special_tokens: true })
        };
      }));
    }
...
var Text2TextGenerationPipeline = class extends /** @type {new (options: TextPipelineConstructorArgs) => Text2TextGenerationPipelineCallback} */
/** @type {any} */
Pipeline {
  /**
  ...
  async _call(texts, generate_kwargs = {}) {
    ...
    const self2 = (
      /** @type {Text2TextGenerationPipeline & Pipeline} */
      /** @type {any} */
      this
    );
    if (self2.model.config.prefix) {
      texts = texts.map((x) => self2.model.config.prefix + x);
    }
    const task_specific_params = self2.model.config.task_specific_params;
    if (task_specific_params && task_specific_params[self2.task]) {
      if (task_specific_params[self2.task].prefix) {
        texts = texts.map((x) => task_specific_params[self2.task].prefix + x);
      }
    }
    ...
    let input_ids;
    if (self2 instanceof TranslationPipeline && "_build_translation_inputs" in /** @type {Pipeline} */
    self2.tokenizer) {
      input_ids = self2.tokenizer._build_translation_inputs(texts, tokenizer_options, generate_kwargs).input_ids;
    } else {
      input_ids = self2.tokenizer(texts, tokenizer_options).input_ids;
    }
    const outputTokenIds = await self2.model.generate(input_ids, generate_kwargs);
    return self2.tokenizer.batch_decode(outputTokenIds, {
      skip_special_tokens: true
    }).map((text) => ({ [self2._key]: text }));
  }
};
var SummarizationPipeline = class extends /** @type {new (options: TextPipelineConstructorArgs) => SummarizationGenerationPipelineCallback} */
/** @type {any} */
...
var TranslationPipeline = class extends /** @type {new (options: TextPipelineConstructorArgs) => TranslationGenerationPipelineCallback} */
/** @type {any} */
Text2TextGenerationPipeline {
  /**
...
var TextGenerationPipeline = class extends /** @type {new (options: TextPipelineConstructorArgs) => TextGenerationPipelineCallback} */
/** @type {any} */
Pipeline {
  /**
  ...
  async _call(texts, generate_kwargs = {}) {
    ...
    self2.tokenizer.padding_side = "left";
    const { input_ids, attention_mask } = self2.tokenizer(texts, {
      add_special_tokens,
      padding: true,
      truncation: true
    });
    const outputTokenIds = await self2.model.generate(input_ids, generate_kwargs, null, {
      inputs_attention_mask: attention_mask
    });
    const decoded = self2.tokenizer.batch_decode(outputTokenIds, {
      skip_special_tokens: true
    });
...
var ZeroShotClassificationPipeline = class extends /** @type {new (options: TextPipelineConstructorArgs) => ZeroShotClassificationPipelineCallback} */
/** @type {any} */
Pipeline {
  /**
  ...
  async _call(texts, candidate_labels, {
    ...
    for (const premise of texts) {
      ...
      for (const hypothesis of hypotheses) {
        const inputs = self2.tokenizer(premise, {
          text_pair: hypothesis,
          padding: true,
          truncation: true
        });
        const outputs = await self2.model(inputs);
        if (softmaxEach) {
          entails_logits.push([
            outputs.logits.data[self2.contradiction_id],
            outputs.logits.data[self2.entailment_id]
          ]);
        } else {
          entails_logits.push(outputs.logits.data[self2.entailment_id]);
        }
      }
...
var FeatureExtractionPipeline = class extends /** @type {new (options: TextPipelineConstructorArgs) => FeatureExtractionPipelineCallback} */
/** @type {any} */
Pipeline {
  /**
...
var AudioClassificationPipeline = class extends /** @type {new (options: AudioPipelineConstructorArgs) => AudioClassificationPipelineCallback} */
/** @type {any} */
Pipeline {
  /**
  ...
  async _call(audio, {
    ...
    const self2 = (
      /** @type {AudioClassificationPipeline & Pipeline} */
      /** @type {any} */
      this
    );
    const single = !Array.isArray(audio);
    const sampling_rate = self2.processor.feature_extractor.config.sampling_rate;
    const preparedAudios = await prepareAudios(audio, sampling_rate);
    const id2label = self2.model.config.id2label;
    const toReturn = [];
    for (const aud of preparedAudios) {
      const inputs = await self2.processor(aud);
      const output = await self2.model(inputs);
...
var ZeroShotAudioClassificationPipeline = class extends /** @type {new (options: TextAudioPipelineConstructorArgs) => ZeroShotAudioClassificationPipelineCallback} */
/** @type {any} */
Pipeline {
  /**
  ...
  async _call(audio, candidate_labels, {
    ...
    const self2 = (
      /** @type {ZeroShotAudioClassificationPipeline & Pipeline} */
      /** @type {any} */
      this
    );
    const single = !Array.isArray(audio);
    ...
    const text_inputs = self2.tokenizer(texts, {
      padding: true,
      truncation: true
    });
    const sampling_rate = self2.processor.feature_extractor.config.sampling_rate;
    ...
    const toReturn = [];
    for (const aud of preparedAudios) {
      const audio_inputs = await self2.processor(aud);
      const output = await self2.model({ ...text_inputs, ...audio_inputs });
...
var AutomaticSpeechRecognitionPipeline = class extends /** @type {new (options: TextAudioPipelineConstructorArgs) => AutomaticSpeechRecognitionPipelineCallback} */
/** @type {any} */
Pipeline {
  /**
  ...
  async _call(audio, kwargs = {}) {
    const self2 = (
      /** @type {AutomaticSpeechRecognitionPipeline & Pipeline} */
      /** @type {any} */
      this
    );
    switch (self2.model.config.model_type) {
      case "whisper":
        return self2._call_whisper(audio, kwargs);
      case "wav2vec2":
      case "hubert":
        return self2._call_wav2vec2(audio, kwargs);
      default:
        throw new Error(`AutomaticSpeechRecognitionPipeline does not support model type '${self2.model.config.model_type}'.`);
    }
  }
  /**
   * @type {AutomaticSpeechRecognitionPipelineCallback}
  ...
  async _call_wav2vec2(audio, kwargs = {}) {
    ...
    for (const aud of preparedAudios) {
      ...
      const predicted_sentences = self2.tokenizer.decode(predicted_ids);
  ...
  async _call_whisper(audio, kwargs = {}) {
    ...
    if (language || task || return_timestamps) {
      ...
      const decoder_prompt_ids = self2.tokenizer.get_decoder_prompt_ids({ language, task, no_timestamps: !return_timestamps });
    ...
    const time_precision = self2.processor.feature_extractor.config.chunk_length / self2.model.config.max_source_positions;
    const hop_length = self2.processor.feature_extractor.config.hop_length;
    const sampling_rate = self2.processor.feature_extractor.config.sampling_rate;
    const preparedAudios = await prepareAudios(audio, sampling_rate);
    const toReturn = [];
    for (const aud of preparedAudios) {
      ...
      if (chunk_length_s > 0) {
        ...
        while (offset < aud.length) {
          ...
          const feature = await self2.processor(subarr);
        ...
        chunks = [{
          ...
          input_features: (await self2.processor(aud)).input_features,
          is_last: true
        }];
      }
      for (const chunk of chunks) {
        kwargs.num_frames = Math.floor(chunk.stride[0] / hop_length);
        const data = await self2.model.generate(chunk.input_features, kwargs);
        if (return_timestamps === "word") {
      ...
      const [full_text, optional] = self2.tokenizer._decode_asr(chunks, {
        time_precision,
        return_timestamps,
...
var ImageToTextPipeline = class extends /** @type {new (options: TextImagePipelineConstructorArgs) => ImageToTextPipelineCallback} */
/** @type {any} */
Pipeline {
  /**
  ...
  async _call(images, generate_kwargs = {}) {
    const self2 = (
      /** @type {ImageToTextPipeline & Pipeline} */
      /** @type {any} */
      this
    );
    const isBatched = Array.isArray(images);
    const preparedImages = await prepareImages(images);
    const { pixel_values } = await self2.processor(preparedImages);
    const toReturn = [];
    for (const batch of pixel_values) {
      batch.dims = [1, ...batch.dims];
      const output = await self2.model.generate(batch, generate_kwargs);
      const decoded = self2.tokenizer.batch_decode(output, {
        skip_special_tokens: true
...
var ImageClassificationPipeline = class extends /** @type {new (options: ImagePipelineConstructorArgs) => ImageClassificationPipelineCallback} */
/** @type {any} */
Pipeline {
  /**
  ...
  async _call(images, {
    ...
    const self2 = (
      /** @type {ImageClassificationPipeline & Pipeline} */
      /** @type {any} */
      this
    );
    const isBatched = Array.isArray(images);
    const preparedImages = await prepareImages(images);
    const { pixel_values } = await self2.processor(preparedImages);
    const output = await self2.model({ pixel_values });
    const id2label = self2.model.config.id2label;
    const toReturn = [];
...
var ImageSegmentationPipeline = class extends /** @type {new (options: ImagePipelineConstructorArgs) => ImageSegmentationPipelineCallback} */
/** @type {any} */
Pipeline {
  /**
  ...
  async _call(images, {
    ...
    const self2 = (
      /** @type {ImageSegmentationPipeline & Pipeline} */
      /** @type {any} */
      this
    );
    const isBatched = Array.isArray(images);
    ...
    const { pixel_values, pixel_mask } = await self2.processor(preparedImages);
    const output = await self2.model({ pixel_values, pixel_mask });
    let fn = null;
    if (subtask !== null) {
      fn = self2.subtasks_mapping[subtask];
    } else {
      for (let [task, func] of Object.entries(self2.subtasks_mapping)) {
        if (func in self2.processor.feature_extractor) {
          fn = self2.processor.feature_extractor[func].bind(self2.processor.feature_extractor);
          subtask = task;
          break;
        }
      }
...
var ZeroShotImageClassificationPipeline = class extends /** @type {new (options: TextImagePipelineConstructorArgs) => ZeroShotImageClassificationPipelineCallback} */
/** @type {any} */
Pipeline {
  /**
  ...
  async _call(images, candidate_labels, {
    ...
    const self2 = (
      /** @type {ZeroShotImageClassificationPipeline & Pipeline} */
      /** @type {any} */
      this
    );
    const isBatched = Array.isArray(images);
    ...
    const text_inputs = self2.tokenizer(texts, {
      padding: self2.model.config.model_type === "siglip" ? "max_length" : true,
      truncation: true
    });
    const { pixel_values } = await self2.processor(preparedImages);
    const output = await self2.model({ ...text_inputs, pixel_values });
    const function_to_apply = self2.model.config.model_type === "siglip" ? (batch) => batch.sigmoid().data : (batch) => softmax(batch.data);
    const toReturn = [];
...
var ObjectDetectionPipeline = class extends /** @type {new (options: ImagePipelineConstructorArgs) => ObjectDetectionPipelineCallback} */
/** @type {any} */
Pipeline {
  /**
  ...
  async _call(images, {
    ...
    const self2 = (
      /** @type {ObjectDetectionPipeline & Pipeline} */
      /** @type {any} */
      this
    );
    const isBatched = Array.isArray(images);
    ...
    const { pixel_values, pixel_mask } = await self2.processor(preparedImages);
    const output = await self2.model({ pixel_values, pixel_mask });
    const processed = self2.processor.feature_extractor.post_process_object_detection(output, threshold, imageSizes);
    const id2label = self2.model.config.id2label;
...
var ZeroShotObjectDetectionPipeline = class extends /** @type {new (options: TextImagePipelineConstructorArgs) => ZeroShotObjectDetectionPipelineCallback} */
/** @type {any} */
Pipeline {
  /**
  ...
  async _call(images, candidate_labels, {
    ...
    const self2 = (
      /** @type {ZeroShotObjectDetectionPipeline & Pipeline} */
      /** @type {any} */
      this
    );
    const isBatched = Array.isArray(images);
    const preparedImages = await prepareImages(images);
    const text_inputs = self2.tokenizer(candidate_labels, {
      padding: true,
      truncation: true
    });
    const model_inputs = await self2.processor(preparedImages);
    const toReturn = [];
    for (let i = 0; i < preparedImages.length; ++i) {
      ...
      const output = await self2.model({ ...text_inputs, pixel_values });
      const processed = self2.processor.feature_extractor.post_process_object_detection(output, threshold, imageSize, true)[0];
...
var DocumentQuestionAnsweringPipeline = class extends /** @type {new (options: TextImagePipelineConstructorArgs) => DocumentQuestionAnsweringPipelineCallback} */
/** @type {any} */
Pipeline {
  /**
  ...
  async _call(image, question, generate_kwargs = {}) {
    const self2 = (
      /** @type {DocumentQuestionAnsweringPipeline & Pipeline} */
      /** @type {any} */
      this
    );
    const preparedImage = (await prepareImages(image))[0];
    const { pixel_values } = await self2.processor(preparedImage);
    const task_prompt = `<s_docvqa><s_question>${question}</s_question><s_answer>`;
    const decoder_input_ids = self2.tokenizer(task_prompt, {
      add_special_tokens: false,
      padding: true,
      truncation: true
    }).input_ids;
    const output = await self2.model.generate(
      pixel_values,
      {
        ...generate_kwargs,
        decoder_input_ids,
        max_length: self2.model.config.decoder.max_position_embeddings
      }
    );
    const decoded = self2.tokenizer.batch_decode(output)[0];
...
var TextToAudioPipeline = class extends /** @type {new (options: TextToAudioPipelineConstructorArgs) => TextToAudioPipelineCallback} */
/** @type {any} */
Pipeline {
  /**
  ...
  async _call(text_inputs, {
    ...
    const self2 = (
      /** @type {TextToAudioPipeline & Pipeline} */
      /** @type {any} */
      this
    );
    if (self2.processor) {
  ...
  async _call_text_to_waveform(text_inputs) {
    ...
    const inputs = self2.tokenizer(text_inputs, {
      padding: true,
      truncation: true
    });
    const { waveform } = await self2.model(inputs);
    const sampling_rate = self2.model.config.sampling_rate;
    return {
      audio: waveform.data,
      sampling_rate
    };
  ...
  async _call_text_to_spectrogram(text_inputs, { speaker_embeddings }) {
    ...
    if (!self2.vocoder) {
      ...
      self2.vocoder = await AutoModel.from_pretrained(self2.DEFAULT_VOCODER_ID, { quantized: false });
    }
    ...
    const { input_ids } = self2.tokenizer(text_inputs, {
      padding: true,
      truncation: true
    });
    const { waveform } = await self2.model.generate_speech(input_ids, speaker_embeddings, { vocoder: this.vocoder });
    const sampling_rate = self2.processor.feature_extractor.config.sampling_rate;
    return {
      audio: waveform.data,
      sampling_rate
...
var ImageToImagePipeline = class extends /** @type {new (options: ImagePipelineConstructorArgs) => ImageToImagePipelineCallback} */
/** @type {any} */
Pipeline {
  /**
  ...
  async _call(images) {
    const self2 = (
      /** @type {ImageToImagePipeline & Pipeline} */
      /** @type {any} */
      this
    );
    const preparedImages = await prepareImages(images);
    const inputs = await self2.processor(preparedImages);
    const outputs = await self2.model(inputs);
    const toReturn = [];
...
var DepthEstimationPipeline = class extends /** @type {new (options: ImagePipelineConstructorArgs) => DepthEstimationPipelineCallback} */
/** @type {any} */
Pipeline {
  /**
  ...
  async _call(images) {
    const self2 = (
      /** @type {DepthEstimationPipeline & Pipeline} */
      /** @type {any} */
      this
    );
    const preparedImages = await prepareImages(images);
    const inputs = await self2.processor(preparedImages);
    const { predicted_depth } = await self2.model(inputs);
    const toReturn = [];
    for (let i = 0; i < preparedImages.length; ++i) {
...
//# sourceMappingURL=transformers-6HVIHXBA.js.map
